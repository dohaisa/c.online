                        ...
                        <div class="single-course mb-40">
                            ...
                            <div class="course-caption">
                                <div class="course-cap-top">
                                    <h4><a href="{{route('coursesingle',[$course->id])}}">{{$course->name}}</a></h4>
                                </div>
                       ...
                       @foreach($latest_news as $latest_news)
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="{{asset('storage/'.$latest_news->image)}}" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>{{ $latest_news->created_at->format('d')}}</span>
                                        <p>{{ $latest_news->created_at->format('F')}}</p>
                                    </div>
                                </div>
                                <div class="blog-cap">
                                    <p>|   Properties</p>
                                    <h3><a href="{{route('blog_details',[$latest_news->id])}}">{{ $latest_news->address }}</a></h3>
