                            ...
                            <div class="main-menu d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">                                                                                          
                                        ...
                                        <li><a href="edu/courses">Courses</a>
                                        <ul class="submenu">
                                                <li><a href="edu/courses">Courses</a></li>
                                                <li><a href="edu/coursesingle">Courses Single</a></li>
                                              </ul>
                                                </li>
                                        <li><a href="edu/instructor">Instructors</a></li>
